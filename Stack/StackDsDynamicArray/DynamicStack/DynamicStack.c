...
/**
  ...
  * @retval :  1 if the stack is full , 0 if the stack is not full
**/
static boolean_t Stack_IsFull(Stack_DyDs_t * My_Stack) ;
...
**/
static boolean_t Stack_IsEmpty(Stack_DyDs_t * My_Stack) ;
